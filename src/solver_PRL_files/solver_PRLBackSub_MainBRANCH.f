      SUBROUTINE PRLBackSub_MainBRANCH(a,nrx)
...
c
      INTEGER k,nrow,ny,ny1,ny1M,nr2,i,nrm
...
c
        ...
        a(ny  + 6) = a(ny  + 7)/a(ny + 3)
        a(ny1 + 6) = a(ny1 + 7) - a(ny1 + 3)*a(ny  + 6)
