      SUBROUTINE bandPRL3diag_TWIG_exp2(a,nzz,nrx)
...
c
      ...
      REAL*8  coef, a01,a02, a03, a07, amx1,amx2
...
c
        ...
        a01 = 0.0
        a(ny2 + 1) = a01
        coef = max ( dabs( a(ny1 +3) ),dabs( a(ny1 +4) ) )
        amx1 = max ( coef, dabs( a(ny1 + 5) ) )
        amx2 = max ( a02,a03 )

        a(ny1 + 3) = a(ny1 + 3)/amx1
        a(ny1 + 4) = a(ny1 + 4)/amx1
        a(ny1 + 5) = a(ny1 + 5)/amx1
        a(ny1 + 7) = a(ny1 + 7)/amx1

        a02 = a02/amx2
        a03 = a03/amx2
        a07 = a07/amx2

        if (dabs(a(ny1 + 5)).gt.dabs(a03)) then
            coef = a(ny1 + 4)
                a(ny1 + 4) = a02
                a02  = coef
        ...
        a(ny1 + 3) = a(ny1 + 3) - a01*coef
        a(ny1 + 4) = a(ny1 + 4) - a02*coef
        a(ny1 + 7) = a(ny1 + 7) - a07*coef

        amx1 = max ( dabs( a(ny + 3) ),dabs( a(ny + 4) ) )
        amx2 = max ( dabs( a(ny1 +3) ),dabs( a(ny1 +4) ) )

        if (dabs(a(ny + 4))/amx1.gt.dabs(a(ny1 + 4))/amx2) then
            coef = a(ny1 + 4)
              a(ny1 + 4) = a(ny + 4)
              a(ny + 4)  = coef
            coef = a(ny1 + 3)
