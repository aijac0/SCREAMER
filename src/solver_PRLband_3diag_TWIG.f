      SUBROUTINE bandPRL3diag_TWIG(a,nzz,nrx)
...
c
      INTEGER k,nrow,nr2,ny,ny1,i,nrm
      REAL*8  coef, a02, a03, a07, amx1,amx2
...
c
c Lets leave the First node in the Screamer format and solve 3 x 3 matrix.
